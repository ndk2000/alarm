...
object CloudConfigKeys {
    ...
    // 默认内置凭据
    const val DEFAULT_SUPABASE_URL = "https://rfwcckmdjfhcahqddaok.supabase.co"
    const val DEFAULT_SUPABASE_ANON_KEY = "sb_publishable_GS1V1vjp5_vyaQGXJnbEAw_CDLhEcNN"
    const val DEFAULT_FIREBASE_PROJECT_ID = "alarmcloud-3ccb1"
    const val DEFAULT_FIREBASE_API_KEY = "AIzaSyCFAqUhfw1n0y3xJfPqovpLyrPQDFSmIFM"
}
