package com.ccsoft.alarm.ui.theme
...
// ========== DroidCloud IDE 设计主题 (Dark only) ==========
private val DesignDarkColorScheme = darkColorScheme(
    primary = DesignDarkPrimary,
    onPrimary = DesignDarkOnPrimary,
    background = DesignDarkBackground,
    onBackground = DesignDarkOnBackground,
    surface = DesignDarkSurface,
    onSurface = DesignDarkOnSurface,
    surfaceVariant = DesignDarkSurfaceVariant,
    onSurfaceVariant = DesignDarkOnSurfaceVariant
)

@Composable
fun Theme(
    appTheme: Int = 0, // 0: 暗夜, 1: 森林, 2: 暖阳, 3: 设计主题
    ...
    val colorScheme = when (appTheme) {
        ...
        3 -> DesignDarkColorScheme // 设计主题只支持深色
