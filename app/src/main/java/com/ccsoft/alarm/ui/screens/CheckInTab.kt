...
import com.ccsoft.alarm.cloud.QrCodeUtils
import com.ccsoft.alarm.db.CheckInGroupEntity
import com.ccsoft.alarm.ui.dialogs.digitsToChineseUpper
...
fun CheckInTab(
    ...
    val vm = androidx.lifecycle.viewmodel.compose.viewModel<com.ccsoft.alarm.ui.AlarmViewModel>()
...
private fun CheckInGroupCard(
    ...
    var isGeneratingRules by remember { mutableStateOf(false) }
                    ...
                    Column(
                        ...
                        Row(
                            ...
                            if (isGeneratingRules) {
                                ...
                                Spacer(modifier = Modifier.width(12.dp))
                                Text("正在生成语音...", fontSize = 12.sp, color = MaterialTheme.colorScheme.primary)
                                Spacer(modifier = Modifier.weight(1f))
                            }

                            Button(
                                enabled = !isGeneratingRules,
                                onClick = {
                                        ...
                                        try {
                                            ...
                                            ruleSegments.forEach { seg ->
                                                ...
                                                while (total <= endTotal) {
                                                    ...
                                                    val cachePath = try {
                                                        com.ccsoft.alarm.alarm.TtsTaskPlayer.generateSync(ctx, ttsText)
